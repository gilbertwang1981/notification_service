...
public class RedisConfigFactory implements NsConfigFactory{
	...
	public NsConfiguration create(NsConfiguration config , NsConfig obj) {
		String maxIdle = System.getenv("VIPNS_REDIS_MAX_IDLE");
		...
		String maxTotal = System.getenv("VIPNS_REDIS_MAX_TOTAL");
		...
		String maxWait = System.getenv("VIPNS_REDIS_MAX_WAIT");
		...
		String minEvicatableIdleTime = System.getenv("VIPNS_REDIS_MIN_EVICATABLE_IDLE_TIME");
		...
		String minIdle = System.getenv("VIPNS_REDIS_MIN_IDLE");
		...
		String timeBetweenEvicationRun = System.getenv("VIPNS_REDIS_TIME_BETWEEN_EVICATION_RUN");
		...
		String address = System.getenv("VIPNS_REDIS_HOSTS");
