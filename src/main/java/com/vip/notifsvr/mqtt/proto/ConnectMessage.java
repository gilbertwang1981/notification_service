...
public class ConnectMessage extends Message {
	...
	protected int messageLength() {
		int payloadSize = NsUtil.toMQttString(clientId).length;
		payloadSize += NsUtil.toMQttString(willTopic).length;
		payloadSize += NsUtil.toMQttString(will).length;
		payloadSize += NsUtil.toMQttString(username).length;
		payloadSize += NsUtil.toMQttString(password).length;
